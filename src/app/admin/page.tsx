...
export default function AdminDashboardPage() {
  ...
  const [subcategoria, setSubcategoria] = useState('Aguardiente Antioqueño');
  ...
  const handleCrearProducto = async (e: React.FormEvent) => {
    ...
    // Limpiar formulario
    setNombre('');
    setCategoria('Aguardiente');
    setSubcategoria('Aguardiente Antioqueño');
    setUnidadMedida('ML');
    setPrecioFinal('');
    setPrecioCosto('');
    setValorPorUnidad('');
  ...
  const pedidosDelDia = pedidos.filter(
    p => p.estado === 'PAGADO' || p.estado === 'PEDIDO ENTREGADO'
  );

  const totalRecaudado = pedidosDelDia.reduce(
    (acc, p) => acc + p.total,
    0
  );

  const totalDigital = pedidosDelDia
    .filter(p => p.metodo_pago !== 'Efectivo')
    .reduce((acc, p) => acc + p.total, 0);

  const totalEfectivo = pedidosDelDia
    .filter(p => p.metodo_pago === 'Efectivo')
    .reduce((acc, p) => acc + p.total, 0);
      ...
      <html>
        ...
        <body>
          ...
          ${pedido.detalle_pedidos?.map(i => `
            <div class="flex">
              <span>
                ${i.cantidad}x ${i.productos?.nombre || 'Producto'}
              </span>

              <span>
                $${(i.precio_unitario * i.cantidad).toLocaleString('es-CO')}
              </span>
            </div>
          `).join('')}
    ...
    <div className="min-h-screen bg-[#fafaf8] text-zinc-900 font-sans">
      ...
      <header className="bg-[#073b78] text-white py-4 px-8 shadow-md flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="bg-white text-[#073b78] font-serif font-black px-3 py-1 text-xl rounded">
            EC
          </div>
          ...
          <div>
            ...
            <p className="text-[10px] text-blue-200 uppercase tracking-widest">
              El Compadre Administrative System
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto p-6 space-y-6">
        ...
        <div className="flex border-b border-zinc-200 gap-2 overflow-x-auto">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-5 py-3 font-bold text-xs uppercase tracking-wider border-b-2 transition-all whitespace-nowrap cursor-pointer ${
              tabActiva === 'productos'
                ? 'border-[#073b78] text-[#073b78]'
        ...
        {tabActiva === 'productos' && (
          <Card className="bg-white border-zinc-200">
            ...
            <CardHeader className="flex flex-row justify-between items-center">
              ...
              <div>
                <CardTitle className="font-serif text-2xl text-[#073b78]">
                  Catálogo de Productos
                </CardTitle>

                <CardDescription>
                  Administra precios, unidades de medida y valores por unidad.
                </CardDescription>
              </div>

              <Dialog
                open={modalProd}
                onOpenChange={setModalProd}
              >

                <Button
                type="button"
                onClick={() => setModalProd(true)}
                className="bg-[#073b78] hover:bg-[#052d5e] text-white font-bold text-xs uppercase tracking-wider"
                >
                  + Nuevo Producto
                  </Button>
                ...
                <DialogContent className="bg-white sm:max-w-md">
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={e => {
                            ...
                            const opciones =
                              SUBCATEGORIAS[
                                nuevaCategoria as keyof typeof SUBCATEGORIAS
                              ];

                            setSubcategoria(opciones?.[0] || '');
                          }}
                        >
                      ...
                      <div>
                        ...
                        >
                          ...
                          {(
                            SUBCATEGORIAS[
                              categoria as keyof typeof SUBCATEGORIAS
                            ] || []
                          ).map(opcion => (
                            <option
                              key={opcion}
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={e => setValorPorUnidad(e.target.value)}
                          placeholder="Ej: 66.6"
                        />
                      </div>
                    ...
                    <DialogFooter className="pt-2">
                      ...
                      <Button
                        type="submit"
                        className="w-full bg-[#073b78] text-white font-bold"
                      >
                        Guardar Producto
                      </Button>
                  ...
                  {productos.map(p => (
                    ...
                    <TableRow key={p.id}>
                      ...
                      <TableCell className="text-right text-zinc-500">
                        ${p.valor_por_unidad || 0} / {p.unidad_medida}
                      </TableCell>

                      <TableCell className="text-right font-bold text-[#073b78]">
        ...
        {tabActiva === 'pedidos' && (
          <div className="space-y-4">
            ...
            <h2 className="font-serif text-2xl text-[#073b78] font-bold">
              Monitor de Pedidos y Despacho
            </h2>
              ...
              >
                ...
                <CardHeader className="bg-zinc-50 flex flex-row justify-between items-center border-b">
                  ...
                  <div>
                    ...
                    <CardTitle className="text-base font-bold text-[#073b78]">
                ...
                <CardContent className="p-4 grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
                  ...
                  <div>
                    ...
                    <h4 className="font-bold uppercase text-zinc-400 mb-1">
                      Dirección:
                    </h4>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="PEDIDO EN PREPARACION">
                        PEDIDO EN PREPARACIÓN
                      </option>

                      <option value="PEDIDO DESPACHADO">
                        PEDIDO DESPACHADO
                      </option>
              ...
              >
                ...
                <div>
                  ...
                  <Input
                    ...
                    value={codigoCupón}
                    onChange={e => setCodigoCupón(e.target.value)}
                  />
                ...
                <div>
                  ...
                  <Input
                    ...
                    type="number"
                    placeholder="10"
                    value={porcentajeCupón}
                    onChange={e => setPorcentajeCupón(e.target.value)}
                  />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card className="bg-white border-zinc-200 shadow-sm">
              ...
              <CardContent>
                ...
                <form
                  onSubmit={handleCrearRepartidor}
                  className="space-y-3 text-xs"
                >
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      value={nomRepartidor}
                      onChange={e => setNomRepartidor(e.target.value)}
                    />
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      value={telRepartidor}
                      onChange={e => setTelRepartidor(e.target.value)}
                    />
            ...
            <Card className="bg-white border-zinc-200 shadow-sm">
              ...
              <CardHeader className="bg-[#073b78] text-white rounded-t-xl">
                ...
                <CardTitle className="font-serif text-xl">
                  Arqueo y Cierre Diario de Caja (Cierre Z)
                </CardTitle>

                <CardDescription className="text-blue-200 text-xs">
                  Resumen financiero consolidado del turno actual.
                </CardDescription>
              ...
              <CardContent className="p-6 space-y-6 text-xs">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
                  ...
                  <div className="bg-zinc-50 p-3 rounded border border-zinc-200">
                    ...
                    <p className="text-base font-black text-blue-700">
                      ${totalDigital.toLocaleString('es-CO')}
                    </p>
                  ...
                  <div className="bg-blue-50 p-3 rounded border border-blue-200">
                    ...
                    <p className="text-lg font-black text-[#073b78]">
                ...
                <form
                  onSubmit={handleGenerarCierre}
                  className="space-y-4 border-t pt-4 border-zinc-200"
                >
                  ...
                  <div>
                    ...
                    <label className="font-bold text-zinc-700">
                      Observaciones o Novedades de Turno
                    </label>
                  ...
                  <Button
                    type="submit"
                    className="w-full bg-[#073b78] hover:bg-[#052d5e] text-white font-bold py-3 uppercase tracking-wider"
                  >
